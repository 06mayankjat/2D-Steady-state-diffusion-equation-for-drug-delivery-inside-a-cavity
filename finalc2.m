...
for t = dt:dt:t_end
    ...
    rho_new = rho_new + v*dt/dx*(circshift(rho_new, [0 -1]) - rho_new) + D*dt/dx^2*(circshift(rho_new, [0 -1]) + circshift(rho_new, [0 1]) + circshift(rho_new, [-1 0]) + circshift(rho_new, [1 0]) - 4*rho_new);
